...
<body><script src="/BILVisiterForm/JS/webcam.js"></script>
	...
	<form name="searchform" action="PhoneSearchServlet" methot="get">
				<center>
...
<center>
	...
	Visitor Id : ${myid}
				...
				<legend>
						...
						<input placeholder="your name"  value=${myname} type="text" name=name tabindex="1" required style="width:95%;height:10px; border: 1px solid black;background:#FFFF99;">
							...
							<input placeholder="your contact number" value=${myphone} type="text" name=phone tabindex="2" required style="width:95%;height:10px; border: 1px solid black;background:#FFFF99;">
							...
							<input placeholder="Your Email Address" value=${myemail} type="email" name=email tabindex="3" style="width:95%;height:10px; border: 1px solid black;background:#FFFF99;">
							...
							<input type=text placeholder="your Address" value=${myaddress} tabindex="5" required name=address style="width:95%;height:20px; border: 1px solid black;background:#FFFF99;">
					
						<font color=black ">
							<b> Contact Person </b> </font> <font color=red>*</font> : <input
								placeholder="Contact Person" value=${cperson} type=text tabindex="6" name=cperson required style="width:95%;height:10px; border: 1px solid black;background:#FFFF99;">
							<font color=black ">	<b>Purpose</b></font> <font color=red>*</font> :
							<input type=text placeholder="Purpose " value=${purpose} tabindex="7" required name=purpose style="width:95%;height:12px; border: 1px solid black;background:#FFFF99;">
